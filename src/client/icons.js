...
export class LighthouseIcon extends React.Component {
  ...
  render() {
    return (
      <svg className="icon icon--lighthouse" width="17px" height="15px" viewBox="0 0 17 15">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(1, 0.769471)" stroke="#000000">
            <g transform="translate(0, 9.230529)">
            ...
            <polyline points="3.25301299 11.230 4.42177594 0 10.737 0 12.200 11.230"></polyline>
          </g>
        </g>
      </svg>
    )
...
export class PinIcon extends React.Component {
  ...
  render() {
    return (
      <svg className="icon icon--pin" width="17px" height="15px" viewBox="0 0 9 13">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(-0., -0.627778)" fill="#000000" fillRule="nonzero">
            <path d="M5.16,2.62 C3.78,2.62 2.66,3.74927436 2.66,5.12 C2.66,6.50 3.78,7.62 5.16,7.62 C6.54514536,7.62 7.66,6.50 7.66,5.12 C7.66,3.74927436 6.54514536,2.62 5.16,2.62 Z M5.16,6.95529226 C4.15896512,6.95529226 3.3390953,6.13545257 3.3390953,5.12773295 C3.3390953,4.12001333 4.15896512,3.30021847 5.16,3.30021847 C6.17436822,3.30021847 6.99423803,4.12005816 6.99423803,5.12 C6.99423803,6.1354974 6.17441304,6.95529226 5.16,6.95529226 Z"></path>
            <path d="M5.16,0.627 C2.68,0.627 0.666,2.78324083 0.666,5.43267899 C0.666,6.96 1.86,9.23 2.58,10.45 C3.05,11.26 3.55,12.0257376 4.00626896,12.610561 C4.48532867,13.2363373 4.87213583,13.5754096 5.16669046,13.6277778 C5.4535045,13.5753757 5.83569587,13.2361171 6.31326456,12.6100021 C6.76194882,12.0216728 7.26797368,11.2576423 7.73816662,10.4586038 C8.45842168,9.23469185 9.66,6.95418531 9.66,5.43262818 C9.66,2.78324083 7.64799198,0.627 5.16,0.627 Z M7.24332436,9.8651935 C6.32035481,11.4648456 5.47299872,12.5457782 5.16240776,12.8217275 C4.85019889,12.5542635 4.01659502,11.4990408 3.08072979,9.87022369 C2.00020444,7.98949047 1.38049767,6.37205481 1.38049767,5.43267899 C1.38045009,3.20349058 3.07892153,1.38992821 5.16,1.38992821 C7.25436421,1.38992821 8.95283566,3.20349058 8.95283566,5.43267899 C8.95288324,6.36666895 8.32975032,7.98222463 7.24332436,9.8651935 Z"></path>
          </g>
        </g>
      </svg>
    )
...
export class HarbourIcon extends React.Component {
  shouldComponentUpdate() {
    return false
  }
  ...
  render() {
    return (
      <svg className="icon icon--harbour" width="14px" height="14px" viewBox="0 0 14 14">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(1, 1)">
            <polygon fill="#EE3339" points="5 1 10 7 5 7"></polygon>
            <path d="M3.79305374,4.83082608 L8.40473886,10.7259805 C6.75954003,11.0688737 5.4131096,10.5707029 4.36544758,9.23146804 C3.31778555,7.89223319 3.12698761,6.42535253 3.79305374,4.83082608 Z" fill="#EE3339" transform="translate(5.904739, 7.830826) rotate(-51) translate(-5.904739, -7.830826) "></path>
            <circle stroke="#EE3339" cx="6" cy="6" r="6"></circle>
          </g>
        </g>
      </svg>
    )
  ...
  render() {
    return (
      <svg className="icon icon--measurement" width="35px" height="20px" viewBox="0 0 47 24" version="1.1">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g>
            <path d="M4,0 L43,0 C45.209139,-4.05812251e-16 47,1.790861 47,4 L47,11 L0,11 L0,4 C-2.705415e-16,1.790861 1.790861,4.05812251e-16 4,0 Z" fill="#FFFFFF"></path>
            <g transform="translate(2, 5)" stroke="#252525" strokeLinecap="square">
            ...
            <polyline stroke="#FFFFFF" strokeWidth="2" strokeLinecap="square" points="2.5 19.5 21.8333811 16.052969 25.8007643 22.6379185 44.5 19.5"></polyline>
            <circle fill="#FFFFFF" cx="2.5" cy="19.5" r="2.5"></circle>
            <circle fill="#FFFFFF" cx="44.5" cy="19.5" r="2.5"></circle>
          </g>
        </g>
      </svg>
    )
    ...
    return (
      <svg className="icon icon--location" width="30px" height="30px" viewBox="0 0 30 30">
        <g stroke="none" strokeWidth="2" fill="none" fillRule="evenodd">
          <g>
            <circle fill="#FFFFFF" cx="15" cy="15" r="6"></circle>
            <circle stroke="#FFFFFF" cx="15" cy="15" r="13"></circle>
            <path d="M15,2 L15,0.5" stroke="#FFFFFF" strokeLinecap="square"></path>
            <path d="M15,29.5 L15,28" stroke="#FFFFFF" strokeLinecap="square"></path>
            <path d="M28.596,16.07 L28.596,14.57" stroke="#FFFFFF" strokeLinecap="square" transform="translate(28.596500, 15.168227) rotate(-90) translate(-28.596500, -15.168227) "></path>
            <path d="M1,16.168 L1,14.668" stroke="#FFFFFF" strokeLinecap="square" transform="translate(1, 15.168227) rotate(-90) translate(-1, -15.168227) "></path>
          </g>
        </g>
      </svg>
    )
  ...
  render() {
    return (
      <svg className="icon icon--trash" width="25px" height="25px" viewBox="0 0 25 31">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(1, 1)" stroke="#FFFFFF" strokeWidth="2">
  ...
  render() {
    return (
      <svg className="icon icon--share" width="13px" height="17px" viewBox="0 0 13 17">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g>
            <circle fill="#FFFFFF" cx="10.5" cy="2.5" r="2.5"></circle>
            <circle fill="#FFFFFF" cx="2.5" cy="8.5" r="2.5"></circle>
            <circle fill="#FFFFFF" cx="10.5" cy="14.5" r="2.5"></circle>
            <polyline stroke="#FFFFFF" strokeWidth="2" points="10.5 2.5 2.5 8.5 10.5 14.6206897"></polyline>
          </g>
        </g>
      </svg>
    )
      ...
      <svg width="28px" height="28px" viewBox="0 0 28 28">
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g transform="translate(0, -0.5)" fill="#FFFFFF">
            <rect x="0" y="12" width="28" height="4"></rect>
            <rect transform="translate(14, 14.5) rotate(-270) translate(-14, -14.5) " x="0" y="12" width="28" height="4"></rect>
          </g>
        </g>
      </svg>
    )
